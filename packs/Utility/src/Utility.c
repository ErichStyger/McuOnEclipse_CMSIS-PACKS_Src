...
**         Num32sToStr             - void Utility_Num32sToStr(uint8_t *dst, size_t dstSize, int32_t val);
...
**         Num32sToStrFormatted    - void Utility_Num32sToStrFormatted(uint8_t *dst, size_t dstSize, int32_t val,...
...
**         strcatNum32s            - void Utility_strcatNum32s(uint8_t *dst, size_t dstSize, int32_t val);
...
**         strcatNum32sFormatted   - void Utility_strcatNum32sFormatted(uint8_t *dst, size_t dstSize, int32_t val,...
...
**         strcatNum32sDotValue100 - void Utility_strcatNum32sDotValue100(uint8_t *dst, size_t dstSize, int32_t num);
...
**         ScanDecimal32sNumber    - uint8_t Utility_ScanDecimal32sNumber(const unsigned char **str, int32_t *val);
**         ScanDecimal32sDotNumber - uint8_t Utility_ScanDecimal32sDotNumber(const unsigned char **str, int32_t...
...
**         ScanSeparatedNumbers    - uint8_t Utility_ScanSeparatedNumbers(const unsigned char **str, uint8_t...
**         ScanDoubleQuotedString  - uint8_t Utility_ScanDoubleQuotedString(const uint8_t **cmd, uint8_t *buf,...
...
**         strtailcmp              - uint8_t Utility_strtailcmp(const uint8_t *str, const uint8_t *tail);
...
/*!
  ...
  \param[in] nofFill Size for the format (right aligned) string, e.g. '2' for "%2d"
*/
void Utility_Num32sToStrFormatted(uint8_t *dst, size_t dstSize, int32_t val, char fill, uint8_t nofFill)
{
...
/*!
  ...
  \param[in] nofFill Number of fill characters
  */
void Utility_strcatNum32sFormatted(uint8_t *dst, size_t dstSize, int32_t val, char fill, uint8_t nofFill)
{
  unsigned char buf[sizeof("-4294967295")]; /* maximum buffer size we need */
...
/*!
  ...
  */
void Utility_strcatNum32s(uint8_t *dst, size_t dstSize, int32_t val)
{
  unsigned char buf[sizeof("-4294967295")]; /* maximum buffer size we need */
 ...
 */
void Utility_Num32sToStr(uint8_t *dst, size_t dstSize, int32_t val)
{
  unsigned char *ptr = ((unsigned char *)dst);
  unsigned char i=0, j;
  unsigned char tmp;
...
** ===================================================================
*/
uint8_t Utility_ScanDecimal32sNumber(const unsigned char **str, int32_t *val)
{
  /* Scans a decimal number, and stops at any non-number. Number can have any preceding spaces. */
  const unsigned char *p = *str;
  bool isNeg;
...
/*
** ===================================================================
**     Method      :  Utility_ScanDecimal32sDotNumber (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t Utility_ScanDecimal32sDotNumber(const unsigned char **str, int32_t *integral, uint32_t *fractional, uint8_t *nofFractionalZeros)
{
  ...
  *nofFractionalZeros = 0;
  res = Utility_ScanDecimal32sNumber(&p, integral);
  if (res != ERR_OK) {
    return res;
  }
  if (*p=='.') {
    ...
    if (*p>='0' && *p<='9') { /* number */
      res = Utility_ScanDecimal32uNumber(&p, fractional);
      if (res != ERR_OK) {
        return res;
      }
    }
...
** ===================================================================
*/
uint8_t Utility_strtailcmp(const uint8_t *str, const uint8_t *tail)
{
  int i, j;
...
** ===================================================================
*/
void Utility_strcatNum32sDotValue100(uint8_t *dst, size_t dstSize, int32_t num)
{
  ...
  Utility_strcatNum16uFormatted(dst, dstSize, (uint16_t)((unsigned)num%100U), '0', 2);
}
...
/*
** ===================================================================
**     Method      :  Utility_ScanSeparatedNumbers (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t Utility_ScanSeparatedNumbers(const unsigned char **str, uint8_t *values, uint8_t nofValues, char separator, Utility_SeparatedNumberType numberType)
{
  int i;
  uint8_t res;
  const unsigned char *p;
  ...
  for(i=0;i<nofValues;i++) {
    if (numberType==Utility_SEP_NUM_TYPE_UINT8) {
      res = Utility_ScanDecimal8uNumber(&p, &values[i]);
    } else if (numberType==Utility_SEP_NUM_TYPE_UINT8_HEX_NO_PREFIX) {
      res = Utility_ScanHex8uNumberNoPrefix(&p, &values[i]);
    } else {
      res = ERR_FAILED;
    }
...
/*
** ===================================================================
**     Method      :  Utility_ScanDoubleQuotedString (component Utility)
**     Description :
...
** ===================================================================
*/
uint8_t Utility_ScanDoubleQuotedString(const uint8_t **cmd, uint8_t *buf, size_t bufSize)
{
  const uint8_t *p = *cmd;
